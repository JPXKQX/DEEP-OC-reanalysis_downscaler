...
LABEL maintainer='Mario Santa Cruz,Antonio Perez,Javier Diez'
LABEL version='0.0.1'
...
# Install user app
RUN git clone -b $branch https://github.com/jpxkqx/mediterranean_reanalysis_downscaler/reanalysis_downscaler && \
